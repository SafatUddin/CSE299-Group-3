...
const WorkspaceInvite = () => {
  ...
  const queryResult = useGetWorkspaceDetailsQuery(workspaceId) as { 
    data: Workspace; 
    isLoading: boolean; 
    error: any; 
    isError: boolean 
  ...
  const { data: workspace, isLoading, error, isError } = queryResult;

  useEffect(() => {
    console.log("Query state changed:", { workspace, isLoading, error, isError });
  }, [workspace, isLoading, error, isError]);
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <Card className="max-w-md">
          <CardHeader>
            <CardTitle>Error Loading Workspace</CardTitle>
            <CardDescription>
              {error?.response?.data?.message || "Unable to load workspace details"}
            </CardDescription>
          </CardHeader>
          <CardContent>
